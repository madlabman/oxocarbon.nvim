...
local base06 = "#ffffff"
local base09 = "#78a9ff"
local oxocarbon = (((vim.o.background == "dark") and {base00 = base00, base01 = blend_hex(base00, base06, 0.085), base02 = blend_hex(base00, base06, 0.18), base03 = blend_hex(base00, base06, 0.3), base04 = blend_hex(base00, base06, 0.82), base05 = blend_hex(base00, base06, 0.95), base06 = base06, base07 = "#08bdba", base08 = "#3ddbd9", base09 = base09, base10 = "#ee5396", base11 = "#33b1ff", base12 = "#ff7eb6", base13 = "#42be65", base14 = "#be95ff", base15 = "#82cfff", peach = "#ffab91", blend = "#131313", none = "NONE"}) or {base00 = base06, base01 = blend_hex(base00, base06, 0.95), base02 = blend_hex(base00, base06, 0.82), base03 = base00, base04 = "#37474F", base05 = "#90A4AE", base06 = "#525252", base07 = "#08bdba", base08 = "#ff7eb6", base09 = "#ee5396", base10 = "#FF6F00", base11 = "#0f62fe", base12 = "#673AB7", base13 = "#42be65", base14 = "#be95ff", base15 = "#FFAB91", blend = "#FAFAFA", none = "NONE"})
if vim.g.oxocarbon_term then
...
vim.api.nvim_set_hl(0, "CursorLineNr", {fg = oxocarbon.base13, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "Normal", {fg = oxocarbon.base05, bg = oxocarbon.base00})
...
vim.api.nvim_set_hl(0, "Visual", {fg = oxocarbon.none, bg = "#333c43"})
...
vim.api.nvim_set_hl(0, "CurSearch", {fg = oxocarbon.base01, bg = oxocarbon.base08})
...
vim.api.nvim_set_hl(0, "Comment", {fg = "#777777", bg = oxocarbon.none, italic = true})
...
vim.api.nvim_set_hl(0, "Keyword", {fg = oxocarbon.base09, bg = oxocarbon.none, italic = true})
...
vim.api.nvim_set_hl(0, "@comment.note", {fg = oxocarbon.base11, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "@string.special.symbol", {link = "SpecialChar"})
vim.api.nvim_set_hl(0, "@string.special.url", {link = "@markup.uri"})
...
vim.api.nvim_set_hl(0, "@markdown.heading", {link = "markdownH1"})
...
vim.api.nvim_set_hl(0, "@function", {fg = oxocarbon.base10, bg = oxocarbon.none, bold = true})
...
vim.api.nvim_set_hl(0, "@keyword", {fg = oxocarbon.base09, bg = oxocarbon.none, italic = true})
vim.api.nvim_set_hl(0, "@keyword.function", {fg = oxocarbon.base08, bg = oxocarbon.none, italic = true})
vim.api.nvim_set_hl(0, "@keyword.operator", {fg = oxocarbon.base08, bg = oxocarbon.none, italic = true})
vim.api.nvim_set_hl(0, "@conditional", {fg = oxocarbon.base09, bg = oxocarbon.none, italic = true})
vim.api.nvim_set_hl(0, "@repeat", {fg = oxocarbon.base09, bg = oxocarbon.none, italic = true})
...
vim.api.nvim_set_hl(0, "@field", {fg = oxocarbon.base12, bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "@markup", {fg = oxocarbon.base04, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@markup.strong", {fg = oxocarbon.none, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@markup.emphasis", {fg = oxocarbon.base10, bg = oxocarbon.none, bold = true})
vim.api.nvim_set_hl(0, "@markup.underline", {fg = oxocarbon.base10, bg = oxocarbon.none, underline = true})
vim.api.nvim_set_hl(0, "@markup.strike", {fg = oxocarbon.base10, bg = oxocarbon.none, strikethrough = true})
vim.api.nvim_set_hl(0, "@markup.heading", {fg = oxocarbon.base10, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@markup.raw", {fg = oxocarbon.base04, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "@markup.link.url", {fg = oxocarbon.base14, bg = oxocarbon.none, underline = true})
...
vim.api.nvim_set_hl(0, "NormalFloat", {fg = oxocarbon.base04, bg = oxocarbon.blend})
...
vim.api.nvim_set_hl(0, "TelescopeBorder", {fg = oxocarbon.base00, bg = oxocarbon.base00})
...
vim.api.nvim_set_hl(0, "TelescopeNormal", {fg = oxocarbon.none, bg = oxocarbon.base00})
...
vim.api.nvim_set_hl(0, "TelescopeResultsTitle", {fg = oxocarbon.base05, bg = oxocarbon.base00})
...
vim.api.nvim_set_hl(0, "NavicIconsInterface", {bg = oxocarbon.none, fg = oxocarbon.base08})
vim.api.nvim_set_hl(0, "NavicIconsColor", {bg = oxocarbon.none, fg = oxocarbon.base08})
vim.api.nvim_set_hl(0, "NavicIconsTypeParameter", {bg = oxocarbon.none, fg = oxocarbon.base08})
vim.api.nvim_set_hl(0, "NavicIconsString", {bg = oxocarbon.none, fg = oxocarbon.base09})
vim.api.nvim_set_hl(0, "NavicIconsKeyword", {bg = oxocarbon.none, fg = oxocarbon.base09})
vim.api.nvim_set_hl(0, "NavicIconsConstant", {bg = oxocarbon.none, fg = oxocarbon.base10})
vim.api.nvim_set_hl(0, "NavicIconsConstructor", {bg = oxocarbon.none, fg = oxocarbon.base10})
vim.api.nvim_set_hl(0, "NavicIconsReference", {bg = oxocarbon.none, fg = oxocarbon.base10})
vim.api.nvim_set_hl(0, "NavicIconsStruct", {bg = oxocarbon.none, fg = oxocarbon.base11})
vim.api.nvim_set_hl(0, "NavicIconsClass", {bg = oxocarbon.none, fg = oxocarbon.base11})
vim.api.nvim_set_hl(0, "NavicIconsObject", {bg = oxocarbon.none, fg = oxocarbon.base11})
vim.api.nvim_set_hl(0, "NavicIconsModule", {bg = oxocarbon.none, fg = oxocarbon.base11})
vim.api.nvim_set_hl(0, "NavicIconsNamespace", {bg = oxocarbon.none, fg = oxocarbon.base11})
vim.api.nvim_set_hl(0, "NavicIconsPackage", {bg = oxocarbon.none, fg = oxocarbon.base11})
vim.api.nvim_set_hl(0, "NavicIconsOperator", {bg = oxocarbon.none, fg = oxocarbon.base11})
vim.api.nvim_set_hl(0, "NavicIconsField", {bg = oxocarbon.none, fg = oxocarbon.base12})
vim.api.nvim_set_hl(0, "NavicIconsNumber", {bg = oxocarbon.none, fg = oxocarbon.base12})
vim.api.nvim_set_hl(0, "NavicIconsBoolean", {bg = oxocarbon.none, fg = oxocarbon.base12})
vim.api.nvim_set_hl(0, "NavicIconsProperty", {bg = oxocarbon.none, fg = oxocarbon.base12})
vim.api.nvim_set_hl(0, "NavicIconsEvent", {bg = oxocarbon.none, fg = oxocarbon.base12})
vim.api.nvim_set_hl(0, "NavicIconsUnit", {bg = oxocarbon.none, fg = oxocarbon.base13})
vim.api.nvim_set_hl(0, "NavicIconsFolder", {bg = oxocarbon.none, fg = oxocarbon.base13})
vim.api.nvim_set_hl(0, "NavicIconsVariable", {bg = oxocarbon.none, fg = oxocarbon.base14})
vim.api.nvim_set_hl(0, "NavicIconsArray", {bg = oxocarbon.none, fg = oxocarbon.base14})
vim.api.nvim_set_hl(0, "NavicIconsFile", {bg = oxocarbon.none, fg = oxocarbon.base14})
vim.api.nvim_set_hl(0, "NavicIconsMethod", {bg = oxocarbon.none, fg = oxocarbon.base13})
vim.api.nvim_set_hl(0, "NavicIconsFunction", {bg = oxocarbon.none, fg = oxocarbon.base13})
vim.api.nvim_set_hl(0, "NavicIconsValue", {bg = oxocarbon.none, fg = oxocarbon.base15})
vim.api.nvim_set_hl(0, "NavicIconsEnum", {bg = oxocarbon.none, fg = oxocarbon.base09})
vim.api.nvim_set_hl(0, "NavicIconsEnumMember", {bg = oxocarbon.none, fg = oxocarbon.base15})
vim.api.nvim_set_hl(0, "NavicText", {bg = oxocarbon.none, fg = oxocarbon.base04})
vim.api.nvim_set_hl(0, "NavicSeparator", {bg = oxocarbon.none, fg = oxocarbon.base03})
...
vim.api.nvim_set_hl(0, "NvimTreeFolderName", {fg = oxocarbon.base04, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NvimTreeIndentMarker", {fg = oxocarbon.base02, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NvimTreeEmptyFolderName", {fg = oxocarbon.base04, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NvimTreeOpenedFolderName", {fg = oxocarbon.base04, bg = oxocarbon.none})
vim.api.nvim_set_hl(0, "NvimTreeNormal", {fg = oxocarbon.base04, bg = oxocarbon.base00})
vim.api.nvim_set_hl(0, "NvimTreeCutHL", {link = "PmenuSel"})
vim.api.nvim_set_hl(0, "NvimTreeCopiedHL", {link = "PmenuSel"})
...
vim.api.nvim_set_hl(0, "TreesitterContext", {bg = oxocarbon.base02})
vim.api.nvim_set_hl(0, "IlluminatedWordWrite", {link = "LspReferenceWrite"})
vim.api.nvim_set_hl(0, "IlluminatedWordRead", {link = "LspReferenceRead"})
vim.api.nvim_set_hl(0, "IlluminatedWordText", {link = "LspReferenceText"})
vim.api.nvim_set_hl(0, "CoverageCovered", {fg = oxocarbon.base13})
vim.api.nvim_set_hl(0, "CoverageUncovered", {fg = oxocarbon.base10})
vim.api.nvim_set_hl(0, "CoveragePartial", {fg = oxocarbon.peach})
vim.api.nvim_set_hl(0, "GitSignsAdd", {fg = oxocarbon.base13})
vim.api.nvim_set_hl(0, "GitSignsChange", {fg = oxocarbon.base11})
vim.api.nvim_set_hl(0, "GitSignsDelete", {fg = oxocarbon.base10})
